...
```text
请从以下 GitHub 地址下载这个 Skill，并将完整文件夹安装到我的 Codex 个人 Skills 目录。请保留 SKILL.md、README.md、LICENSE.md、agents、references 和 scripts 等全部文件及原有目录结构。安装后检查文件是否完整，并告诉我如何调用它。

Skill 地址：
https://github.com/davidqd/independent-site-workflow-skills/tree/main/skills/geo-article-writer
```
